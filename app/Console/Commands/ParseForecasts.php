...
class ParseForecasts extends Command
{
    ...
    private array $typesForExclude = [
        ...
        'Единая лига ВТБ', 'Броски в створ ворот', 'Голы в большинстве', 'Росси', 'Настольный теннис', 'Шахматы',
        'Фигурное катание', 'Индия. Суперкубок', 'Гандбол', 'Волейбол. European - Championship U20',
    ];
